...
// ACLAddEntity provides a mock function with given fields: entityType, entityName, aclName, direct, match, action, priority, external_ids, logflag, meter, severity
func (_m *Client) ACLAddEntity(entityType goovn.EntityType, entityName string, aclName string, direct string, match string, action string, priority int, external_ids map[string]string, logflag bool, meter string, severity string) (*goovn.OvnCommand, error) {
...
// ACLDelEntity provides a mock function with given fields: entityType, entityName, aclUUID
func (_m *Client) ACLDelEntity(entityType goovn.EntityType, entityName string, aclUUID string) (*goovn.OvnCommand, error) {
...
// ACLListEntity provides a mock function with given fields: entityType, entityName
func (_m *Client) ACLListEntity(entityType goovn.EntityType, entityName string) ([]*goovn.ACL, error) {
	ret := _m.Called(entityType, entityName)

	var r0 []*goovn.ACL
	if rf, ok := ret.Get(0).(func(goovn.EntityType, string) []*goovn.ACL); ok {
		r0 = rf(entityType, entityName)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*goovn.ACL)
		}
...
func (_m *Client) ACLSetName(aclUUID string, aclName string) (*goovn.OvnCommand, error) {
